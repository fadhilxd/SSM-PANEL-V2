...
if(!preg_match('/[^+0-9]/',trim($nohp))){
         ...
         elseif(substr(trim($nohp), 0, 1)=='0'){
    		...
    		} else if($post_method == "082282297528") {
...
<hr>
<h5>Silahkan Transfer Pembayaran Yang Sesuai Ke <b>082282297528</b> Dengan Nominal Transfer <b>Rp <?php echo $post_quantity; ?></b><br />
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<select class="form-control" name="method" id="depomethod">
														...
														<option value="081317758282">TSEL-081317758282</option>
													</select>
                                ...
                                <div class="panel panel-custom panel-border">
                                    ...
                                    <b>Cara Melakukan Deposit Otomatis</b>:
					                    <ul>
						                    ...
						                    <li>Masukan Jumlah Pembayaran, Minimal Deposit Adalah <b>10.000</b></li>
