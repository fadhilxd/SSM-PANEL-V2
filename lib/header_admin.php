...
<html>
	<head>
		...
		<link rel="icon" href="<?php echo $config['web']['base_url'] ?>assets/images/favicon.ico" type="image/png" sizes="16x16">
				...
				<div class="container-fluid">
					<div class="logo">
						<a href="<?php echo $config['web']['base_url'] ?>" class="logo">
							<span class="logo-small"><img src="<?php echo $config['web']['base_url'] ?>assets/images/favicon.ico" width="25"></span>
							<span class="logo-large"><img src="<?php echo $config['web']['base_url'] ?>assets/images/favicon.ico" width="25"> <?php echo $config['web']['title'] ?></span>
						</a>
					</div>
