...
<html>
	<head>
		...
		<link rel="icon" href="<?php echo $config['web']['base_url'] ?>assets/images/logo_sm.png" type="image/png" sizes="16x16">
				...
				<div class="container-fluid">
					<div class="logo">
						<a href="<?php echo $config['web']['base_url'] ?>" class="logo">
							<span class="logo-small"><img src="<?php echo $config['web']['base_url'] ?>assets/images/logo_sm.png"></span>
							<span class="logo-large"><img src="<?php echo $config['web']['base_url'] ?>assets/images/logo_sm.png"> <?php echo $config['web']['title'] ?></span>
						</a>
					</div>
...
?> 
								...
								<li class="has-submenu">
									<a href="#"><i class="fa fa-envelope"></i>Hubungi kami</a>
									<ul class="submenu">
										<li><a href="https://api.whatsapp.com/send?phone=<?php echo $config['web']['kontak_whatsapp']; ?>" target="_blank">Via Whatsapp</a></li>
									</ul>
								</li>
								<li>
