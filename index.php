...
?>
				<div class="row">
					<div class="col-lg-12">
		                <div class="card-box">
                                <center>
                                    <img src="<?php echo $config['web']['base_url'] ?>assets/images/logo.png" width="300">
					...
					<div class="col-lg-4">
                        <div class="card-box">
                        	...
                        	<small>Kami menyediakan berbagai layanan terbaik untuk kebutuhan sosial media</small>
                        	</center>
                        </div>
                    </div>
