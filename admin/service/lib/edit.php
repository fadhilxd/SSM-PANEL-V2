...
?>
	...
	<div class="form-group">
	    ...
	    <select class="form-control" name="rate">
	        <option value="<?php echo $data_target['rows']['rate'] ?>"><?php echo $data_target['rows']['rate'] ?></option>
	        <option value="1">Harga / 1 (For Type Package)</option>
	        <option value="1000">Harga / 1000 (For Type Default)</option>
	    </select>
	</div>
	<div class="form-group">
	    <label>Type</label>
	    <select class="form-control" name="type">
	        <option value="<?php echo $data_target['rows']['type'] ?>"><?php echo $data_target['rows']['type'] ?></option>
