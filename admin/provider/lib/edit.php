...
<form class="form-horizontal" method="POST" id="form-add">
	...
	<div class="form-group">
		<label>API ID</label>
		<input type="number" class="form-control" name="api_id" value="<?php echo $data_target['rows']['api_id'] ?>">
	</div>
	<div class="form-group">
		<label>API Key</label>
	...
	<div class="form-group">
		...
		<input type="text" class="form-control" name="secret_key" value="<?php echo $data_target['rows']['secret_key'] ?>">
	</div>
	<div class="form-group">
		<label>API Url (Services)</label>
		<input type="text" class="form-control" name="api_url_services" value="<?php echo $data_target['rows']['api_url_services'] ?>">
	</div>
	<div class="form-group">
